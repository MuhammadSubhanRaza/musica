...
<div class="home">
      <div class="background_image" style="background-image:linear-gradient(to bottom,rgba(0, 0, 0, 0.6),rgba(0, 0, 0, 0.3)),
        url('{{asset('musica_assets/images/newback4.jpg')}}')"></div>
              ...
              <div class="home_content">
                ...
                <div class="track track_home">
                  <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay"
                    src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/197004056&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_comments=false&amp;show_user=false&amp;show_reposts=false&amp;show_teaser=false"></iframe>
                </div>
          ...
          <div class="col-lg-4">
            <div class="show">
              <div class="show_image">
                ...
                <div class="show_play_icon"><img src="{{asset('musica_assets/images/play.svg')}}"
                    alt="https://www.flaticon.com/authors/cole-bemis"></div>
              </div>
                  ...
                  <div class="show_comments">
                    <a href="#">
                      <div class="d-flex flex-row align-items-center justify-content-start">
                        <div class="show_comments_icon show_info_icon"><img class="svg" src="images/speech-bubble.svg"
                            alt=""></div>
    ...
    <div class="weekly" style="background: url('{{asset('musica_assets/images/newback2.jpg')}}');">
      <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{asset('musica_assets/images/homeback4.jpg')}}"
        data-speed="0.8"></div>
      <div class="container">
